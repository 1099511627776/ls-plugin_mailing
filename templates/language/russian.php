...
return array(
    ...
    'subscribe_activate' => 'Активация подписки',
    'subscribe_activate_text' => '<p>Подтвердите подписку на рассылку перейдя по <a href="'.Config::Get('path.root.web').'/mailing/aactivate?email=%%email%%&hash=%%hash%%">ссылке</a></p>',
